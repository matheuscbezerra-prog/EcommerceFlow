...
class _CepWidgetState extends State<CepWidget> {
  ...
  void initState() {
    ...
    _model.textField2TextController ??= TextEditingController(text: ' ');
    _model.textField2FocusNode ??= FocusNode();

    _model.textField3TextController ??= TextEditingController(text: ' ');
    _model.textField3FocusNode ??= FocusNode();

    _model.textField6TextController ??= TextEditingController(text: ' ');
    _model.textField6FocusNode ??= FocusNode();

    _model.textField4TextController ??= TextEditingController(text: ' ');
    _model.textField4FocusNode ??= FocusNode();

    _model.textField5TextController ??= TextEditingController(text: ' ');
    _model.textField5FocusNode ??= FocusNode();

    _model.textField1TextController ??= TextEditingController(text: '  ');
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        key: scaffoldKey,
        backgroundColor: Color(0xFF781717),
        appBar: AppBar(
          backgroundColor: Color(0xFF456D30),
        ...
        body: SafeArea(
          ...
          child: Stack(
            children: [
                    ...
                    Row(
                      ...
                      children: [
                        ClipRRect(
                          ...
                          child: Image.network(
                            'https://s3.amazonaws.com/appforest_uf/f1519547432570x648548603290692000/Screenshot%202018-02-25%20at%2009.24.39.png',
                            width: 394.4,
                            height: 191.4,
                            fit: BoxFit.cover,
                          ),
              ...
              Align(
                alignment: AlignmentDirectional(-0.92, -0.44),
                child: Text(
                  'CEP',
              ...
              Align(
                alignment: AlignmentDirectional(-0.83, -0.11),
                child: Container(
                  width: 200.0,
                  child: TextFormField(
              ...
              Align(
                alignment: AlignmentDirectional(-0.84, 0.16),
                child: Container(
                  width: 200.0,
                  child: TextFormField(
                    ...
                    cursorColor: FlutterFlowTheme.of(context).primaryText,
                    enableInteractiveSelection: true,
                    validator: _model.textField3TextControllerValidator
                        .asValidator(context),
                  ),
                ),
              ),
              Align(
                ...
                child: Container(
                  width: 200.0,
                  child: TextFormField(
                    controller: _model.textField6TextController,
                    focusNode: _model.textField6FocusNode,
                    autofocus: false,
                    enabled: true,
                    obscureText: false,
                    decoration: InputDecoration(
                    ...
                    cursorColor: FlutterFlowTheme.of(context).primaryText,
                    enableInteractiveSelection: true,
                    validator: _model.textField6TextControllerValidator
                        .asValidator(context),
                  ),
                ),
              ),
              Align(
                ...
                child: Container(
                  ...
                  child: TextFormField(
                    ...
                    cursorColor: FlutterFlowTheme.of(context).primaryText,
                    enableInteractiveSelection: true,
                    validator: _model.textField4TextControllerValidator
                        .asValidator(context),
                  ),
                ),
              ),
              ...
              Align(
                ...
                child: Container(
                  ...
                  child: TextFormField(
                    ...
                    cursorColor: FlutterFlowTheme.of(context).primaryText,
                    enableInteractiveSelection: true,
                    validator: _model.textField5TextControllerValidator
                        .asValidator(context),
                  ),
                ),
              ),
                      ...
                      child: Container(
                        ...
                        child: TextFormField(
                          ...
                          onChanged: (_) => EasyDebounce.debounce(
                            ...
                            () async {
                              _model.apiResult01f = await BuscarCEPCall.call();
                              ...
                              safeSetState(() {
                                _model.textField2TextController?.text =
                                    'Rua Antônio Costa Ernesto';
                              });
                              safeSetState(() {
                                _model.textField3TextController?.text =
                                    'Jardim Maracá';
                              });
                              safeSetState(() {
                                _model.textField4TextController?.text = '302';
                              });
                              safeSetState(() {
                              ...
                              safeSetState(() {
                                _model.textField6TextController?.text = 'SP';
                              });
